...
<div @class([
    ...
    @forelse($notes as $note)
        ...
        <article
            x-data="{
                pinned: {{ $note->is_pinned ? 'true' : 'false' }},
                loading: false,
                ...
                async togglePin() {
                    ...
                    try {
                        ...
                        const response = await fetch('{{ route('notes.toggle-pin', $note->id) }}', {
                            method: 'POST',
                        ...
                        alert('Не удалось изменить статус закрепления');
        ...
        >
            ...
            <div class="mb-3 flex items-start justify-between gap-3">
                ...
                >
                    ...
                    <span
                        aria-hidden="true"
                        :class="pinned ? 'rotate-12 scale-110' : ''"
            ...
            @if($note->content)
                ...
                <p class="mb-5 line-clamp-4 text-sm leading-6 text-slate-600">
                    {{ $note->content }}
                </p>

            @else

                <p class="mb-5 text-sm italic text-slate-400">
                    Без описания
                </p>
            ...
            <div class="mt-auto flex gap-2">
                ...
                <a
                    ...
                    class="ui-btn-secondary flex-1 py-2 text-center"
                >
                    Редактировать
                </a>
                ...
                >
                    ...
                    <button
                        type="submit"
                        class="ui-btn-danger w-full py-2"
                    >
                        Удалить
                    </button>
